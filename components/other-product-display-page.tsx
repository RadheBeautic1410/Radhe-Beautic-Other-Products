  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-gradient-to-br from-purple-50 via-pink-50 to-blue-50 dark:from-gray-950 dark:via-purple-950/30 dark:to-blue-950/30">
          ...
          <div className="container mx-auto px-4 py-8">
            <div className="space-y-2">
              ...
              <div className="flex items-center gap-2 text-gray-700 dark:text-gray-300">
                <span className="text-lg font-semibold">{productType}</span>
                {subType && (
                  <>
                    <span className="text-purple-500">/</span>
                    <span className="text-lg text-purple-600 dark:text-purple-400 font-medium">{subType}</span>
                  </>
                )}
              </div>
            </div>
        ...
        <div className="container mx-auto px-4 py-8">
          {(() => {
            // Flatten all images from all products into individual cards
            const allImageCards: Array<{ product: OtherProduct; image: ProductImage; imageIndex: number; key: string }> = []
